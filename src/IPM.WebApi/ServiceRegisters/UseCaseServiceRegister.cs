...
public static class UseCaseServiceRegister
{
    public static IServiceCollection AddUseCaseServices(this IServiceCollection services)
    {
        ...
        services.AddScoped<IGetOwnProjectUseCase, GetOwnProjectHandler>();
        ...
        services.AddScoped<ISoftDeleteFileUseCase, SoftDeleteFileHandler>();
        services.AddScoped<IUpdateFileTypeOfFileUseCase, UpdateFileTypeOfFileHandler>();
        ...
        services.AddScoped<IVerifyUserUseCase, VerifyUserHandler>();
